...
#------------------------------------------------------------------------------#
# $Id:: header.pl 150 2010-12-07 08:25:57 tonk                              $: #
# $Revision:: 150                                                           $: #
# $Author:: Ton Kersten <tonk@tonkersten.com>                               $: #
# $Date:: 2010-12-07 08:26:07 +0100 (Tue, 07 Dec 2010)                      $: #
# $Hash::                                                                   $: #
#------------------------------------------------------------------------------#
...
{	print OUT "\n";
	print OUT "$cl";
	printline($wd, 0, " This file is under Puppet control.");
	printline($wd, 0, " Do NOT edit this file, but the master file at");
	printline($wd, 0, " \$Fname:: .../header.pl                                                    $: ");
	print OUT "$cl";
}
